...
class ZielErreichtUser(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, id=None, name=None, hoehe=None, schwierigkeit=None, bild=None, lat=None, lng=None, datum=None):  # noqa: E501
    ...
    @property
    def datum(self) -> date:
        """Gets the datum of this ZielErreichtUser.
    ...
    def datum(self, datum: date):
        """Sets the datum of this ZielErreichtUser.
